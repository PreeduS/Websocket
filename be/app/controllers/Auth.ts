...
class AuthController{
     ...
     signIn: Auth.Controller.SignIn = async (req, res) => {
    ...
    signUp: Auth.Controller.SignUp = async (req, res) => {
    ...
    tokenSignIn:  Auth.Controller.TokenSignIn = async (req, res) => {
    ...
    getAccessToken: Auth.Controller.GetAccessToken = (req, res) => {
        const { refreshToken } = req.body;
