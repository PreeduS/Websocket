...
const localStrategy_1 = __importDefault(require("./auth/localStrategy/localStrategy"));
...
// db
mongoose_1.default.connect('mongodb://localhost:27017/app', { useNewUrlParser: true }).then(() => {
